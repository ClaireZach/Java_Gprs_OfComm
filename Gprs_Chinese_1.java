...
public class MainS_Chinese1125_2 extends JFrame implements ActionListener,SerialPortEventListener{

	// private StringBuffer SbheadStr = new StringBuffer(headStr);
	// private StringBuffer SbcdStr = new StringBuffer(cdStr);
	// private StringBuffer Sbset_orderStr = new StringBuffer(set_orderStr);
	// private StringBuffer Sbread_orderStr = new StringBuffer(read_orderStr);
...
//	private String apnStr, rateStr, modeStr, netStr;
//	private String portStr, restartTime, ipStr, crcStr;
	...
	public static void main(String[] args) {
		new MainS_Chinese1125_2();
	}

	/**
	 * Create the application.
	 */
	public MainS_Chinese1125_2() {
	...
	public void serialEvent(SerialPortEvent event) {
		...
		case SerialPortEvent.DATA_AVAILABLE:
			...
			try {
				...
				String b2h = Convert8.bytesToHexString(s.getBytes());
				//System.out.println(b2h);
				
				
				StringBuilder receivedMsg = new StringBuilder("[接收]：");
				receivedMsg.append(b2h).append("\n");
...
//			setBtnsEnabled(true);
	...
	public void sendreadallBtnSeriaPort() {
		try {
			...
			//TODO
			//outputStream.write(Convert2.hexString2Bytes(mesg));
			outputStream.write(Convert7.hexStringToByte(mesg));
			outputStream.flush();
		} catch (IOException e) {
			showErrMesgbox(e.getMessage());
		}
